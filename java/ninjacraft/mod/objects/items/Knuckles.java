...
public class Knuckles extends ItemSword implements IHasModel {

	private float scale;



	public Knuckles(String name, ToolMaterial material) {
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
		...
		if (chance <= 90 && chance >= 1) {
			...
			Actions.addPotionEffect(target, MobEffects.WEAKNESS, 89, 0, false);
			Actions.addPotionEffect(target, MobEffects.BLINDNESS, 89, 100, false);
			Actions.damageEntity(target, 10);
