...
public class MasterArmor2 extends ItemArmor implements IHasModel {

	public MasterArmor2(String name, CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn,
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		if (this.getEquipmentSlot() == EntityEquipmentSlot.HEAD) {
			Actions.addPotionEffect(player, MobEffects.NIGHT_VISION, 89, 5, false);
