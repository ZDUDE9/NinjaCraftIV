...
public class Master_Armor extends ItemArmor implements IHasModel {

	public Master_Armor(String name, CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn,
