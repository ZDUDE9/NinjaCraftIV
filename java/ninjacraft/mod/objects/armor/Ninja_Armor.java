...
public class Ninja_Armor extends ItemArmor implements IHasModel {

	public Ninja_Armor(String name, CreativeTabs tab, ArmorMaterial materialIn, int renderIndexIn,
